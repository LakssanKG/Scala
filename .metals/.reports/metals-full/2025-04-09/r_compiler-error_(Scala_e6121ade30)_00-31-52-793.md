file:///C:/Users/K.G.LAKSSAN/OneDrive/Documents/Scala/class3.scala
### java.lang.AssertionError: assertion failed: position not set for runtimeChecked(<empty>) # -1 of class dotty.tools.dotc.ast.Trees$Apply in C:/Users/K.G.LAKSSAN/OneDrive/Documents/Scala/class3.scala
...
object Employee{
    def apply(data:String):Employee={
        val Array(name,salary)=data.split(",").map(_.t@@)
    }
}
